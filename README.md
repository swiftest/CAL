...
- Run CAL.ipynb in the Jupyter environment (ensure that external modules such as einops and torchsummary are installed).
...
<img src="figure/CAL_Scheme.png" height="200"/>
